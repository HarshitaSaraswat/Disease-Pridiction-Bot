...
if __name__ == "__main__":
    ...
    title = Label(content, text="Disease Prediction Bot", width=20,
    ...
    about = Button(content, text="People can interact with the bot just like they\n do with another human and through a series of queries,\n chatbot will identify the symptoms of the user and thereby,\n predicts the disease and recommends treatment.",
                   width=44, height=4, background=bg_color_brrr,  activebackground=light_blue, foreground=fore, font="Dyuthi 10")

    add_sympt = Button(content, text="Add Symptom", command=add_symptom, width=25, height=1,
                       font="Dyuthi 18", background=bg_color_brrr,  activebackground=light_blue, foreground=fore)

    sl = StringVar()
    sl.set(shown_list)

    sympt_list = Listbox(content, listvariable=sl,
                         width=32, height=7, font=body_font, background=bg_color_brrr, selectbackground=light_blue, foreground=fore)

    txt = Text(content, width=30, height=1.5, padx=15,
               pady=15, font=body_font, background=bg_color_brrr, foreground=fore)

    clear = Button(content, text="clear", command=clear_txt,
                   width=39, height=1, background=bg_color_brrr,  activebackground=light_blue, foreground=fore, font="Dyuthi 12")

    do_predict = Button(content, text="Click to Predict", command=predict_dis,
                        width=26, height=2, background=bg_color_brrr,  activebackground=light_blue, foreground=fore, font="Dyuthi 18")

    dis_name = Label(content, text="Disease Name will occur here", width=33, height=1,
                     background=bg_color_brrr,  activebackground=light_blue, foreground=fore, font="Dyuthi 14")

    about_dis = Text(content, width=14, height=12,
    ...
    precau = Text(content, width=14, height=12, wrap='word',
